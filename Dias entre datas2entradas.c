...
main()
{
    int dia1, dia2, mes1, mes2, ano1, ano2, i, dia11, dia12, mes11, mes12, dia21, dia22, mes21, mes22;
    long int diastotais = 0;
    long int diastotais1 = 0;
    long int diastotais2 = 0;

    scanf("%i%i/%i%i/%i %i%i/%i%i/%i", &dia11, &dia12, &mes11, &mes12, &ano1, &dia21, &dia22, &mes21, &mes22, &ano2);
